...
class check_non_dispo:
    ...
    def is_not_dispo(self, d, f, j):
        ...
        return "is_not_dispo = %s" % str(resultat)
...
if __name__ == '__main__':
    ...
    for jeu in list_jeu_de_tests:
        print(jeu[0])
        print(app.is_not_dispo(jeu[1],jeu[2],jeu[3]))
